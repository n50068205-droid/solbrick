...
const CHAT_RESPONSES: {[key: string]: string} = {
  'привет': 'Привет! 👋 Я помогу вам разобраться с инвестициями в SolBrick. Что вас интересует?',
  'hello': 'Hello! 👋 How can I help you today?',
  'как купить': 'Для покупки доли:\n1. Подключите Phantom Wallet\n2. Выберите проект\n3. Нажмите "Купить долю"\n4. Подтвердите транзакцию в кошельке ✅',
  'roi': 'ROI (Return on Investment) — это ожидаемая доходность проекта в % годовых. Наши проекты дают от 9.8% до 22.5% годовых 📈',
  'solana': 'SolBrick работает на блокчейне Solana — это быстро, дёшево и безопасно. Все транзакции записываются on-chain навсегда 🔗',
  'phantom': 'Phantom Wallet — это браузерное расширение для работы с Solana. Скачайте на phantom.app и создайте кошелёк бесплатно 👻',
  'минимум': 'Минимальная инвестиция — всего $20 (1 доля в KazHub). Начать можно с любой суммы! 💰',
  'безопасно': 'Да! Все транзакции защищены смарт-контрактом Anchor на Solana. Ваши доли записаны в блокчейн и принадлежат только вам 🔒',
  'дивиденды': 'Доход от аренды и продажи объектов распределяется пропорционально долям прямо через смарт-контракт 📊',
};
